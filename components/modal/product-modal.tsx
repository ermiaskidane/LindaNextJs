      ...
      >
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
            ...
            {/* <FormField
              ...
              <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input disabled={loading} placeholder="Product color" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input disabled={loading} placeholder="Product size" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input disabled={loading} placeholder="Product category" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              />
              <Button disabled={loading} className="w-1/2 mt-8 self-center !bg-[#0084c1fb]" type="submit">
                {action}
              </Button>
            </div>
          </form>
